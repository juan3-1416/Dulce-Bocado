...
class PedidosEstadoInicialSeeder extends Seeder
{
    public function run(): void
    {
        $permiso = Permiso::firstOrCreate(
            [
                'nombre' => 'pedidos.gestionar_estado_entrega',
            ],
            [
                'descripcion' =>
                    'Permite cambiar el estado de los pedidos (iniciar preparación, entregar y cancelar).',
                'activo' => true,
            ]
        );
